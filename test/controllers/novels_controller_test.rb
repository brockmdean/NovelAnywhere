...
class NovelsControllerTest < ActionController::TestCase
  ...
  test "should create novel" do
    assert_difference('Novel.count') do
      post :create, novel: { description: @novel.description, genere: @novel.genere, title: @novel.title }
    end
  ...
  test "should update novel" do
    patch :update, id: @novel, novel: { description: @novel.description, genere: @novel.genere, title: @novel.title }
    assert_redirected_to novel_path(assigns(:novel))
  end
